  ...
  <div class="app-content pt-3 p-md-3 p-lg-4">
    <div class="container-xl">
      ...
      <div class="row g-3 mb-4 align-items-center justify-content-between">
        ...
        <a href="{{asset('/contratos/create')}}"  button type="submit" class="btn bg-primary text-light ">
        ...
        <div class="col-auto">
           <div class="page-utilities">
            <div class="row g-2 justify-content-start justify-content-md-end align-items-center">
              <div class="col-auto">
                <form class="table-search-form row gx-1 align-items-center" action="{{asset('/contratos')}}" method="GET">
                  ...
                  <table class="table app-table-hover mb-0 text-left">
                    ...
                    <tbody>
                        <tr>
                           ...
                           <td>{{$contratos->empresa_cliente->Nome_Empresa ?? 'Sem registros'  }}</td>
