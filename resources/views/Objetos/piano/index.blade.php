...
<head>
  <meta charset="UTF-8">
  <title>CodePen - JavaScript Piano</title>
  <link rel="stylesheet" href="{{asset('/css/piano/piano-style.css')}}">
...
<body>
  <section id="wrap">
    <header>
      <h1>Piano</h1>
      <h2>Utilize o teclado para tocar.</h2>
    </header>
    <section id="main">
  ...
  <a class="btn btn-primary" href="/painel"> Voltar </a>
...
<!-- partial -->
  <script src="{{asset('/js/piano/piano-script.js')}}"></script>
