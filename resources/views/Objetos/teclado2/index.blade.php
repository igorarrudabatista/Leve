...
<head>
  <meta charset="UTF-8">
  <title>CodePen - Keyboard Hero</title>
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/meyer-reset/2.0/reset.min.css">
<link rel="stylesheet" href="{{asset('/css/teclado2/teclado2-style.css')}}">


</head>
<body>
<!-- partial:index.partial.html -->
<h1 class="title">Olhos na tela</h1>
<div class="keyboard">
  <ul class="row row-0">
...
<h1 class="title">Mãos no teclado</h1>



<a href="/painel"> <h6 class="title">Voltar</h6> </a>



<!-- partial -->
  <script  src="./script.js"></script>
  <script src="{{asset('/js/teclado2/teclado2-script.js')}}"></script>
