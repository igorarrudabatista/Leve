...
<br>
    ...
    <label for="validationDefault01"> <strong> Nome do Produto </strong> </label>
      {!! Form::text('Nome_Produto', null, array('placeholder' => 'Nome do produto','class' => 'form-control')) !!}

    </div>
    <div class="col-md-4 mb-3">
    <label for="validationDefault02"> <strong> Categoria</strong></label>
  ...
  <button type="submit" class="btn btn-primary me-1 mb-1">Salvar produto</button>
</form>
