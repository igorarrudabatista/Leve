...
<body class="app app-404-page">   	
	    ...
	    <div class="row">
		    <div class="col-12 col-md-11 col-lg-7 col-xl-6 mx-auto">
			    ...
			    <div class="app-card p-5 text-center shadow-sm">
				    <h1 class="page-title mb-4">404<br><span class="font-weight-light">ERRO!</span></h1>
				    <div class="mb-4">
					    Descupe, não encontramos a página que você procura.
				    </div>
				    <a class="btn app-btn-primary" href="{{asset('/')}}">Voltar</a>
			    </div>
		    </div><!--//col-->
	    </div><!--//row-->
    </div><!--//container-->
    ...
    <footer class="app-footer">
        ...
        <small class="copyright">Desenvolvido <span class="sr-only"></span><i class="fas fa-heart" style="color: #fb866a;"></i> por <a class="app-link" href="https://www.webmonkey.com.br.com.br" target="_blank"></a> Web Monkey</small>
